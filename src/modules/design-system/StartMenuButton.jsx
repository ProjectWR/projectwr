...
const StartMenuButton = ({
  ...
  return (
    <button
      className={`StartMenuButton  text-lg flex items-center justify-center border border-zinc-200 dark:border-zinc-900 transition-all ease-in-out duration-100 ${
