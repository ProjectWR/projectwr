...
const Footer = () => {
  ...
  return (
    <div
      id="FooterContainer"
      className="border-y bg-appBackgroundAccent basis-0 border-appLayoutBorder w-full h-footerHeight min-h-footerHeight grow-0 flex flex-row justify-end font-sans"
    >
