        ...
        <Dialog.Content className="fixed left-[50%] top-[50%] translate-x-[-50%] z-[10002] translate-y-[-50%] w-full max-w-[30rem] bg-appBackgroundAccent border border-appLayoutBorder rounded-md shadow-2xl shadow-appLayoutGentleShadow">
          <div className="flex flex-col gap-2">
            <div className="flex items-center justify-between pt-1 pr-1">
              <Dialog.Title className="text-[1.1rem] text-appLayoutText px-4">
                {title}
              </Dialog.Title>
              <Dialog.Close className='p-1 h-full' asChild>
                <button
                  className={`h-full flex items-center justify-center w-fit p-px rounded-md text-appLayoutHighlight hover:bg-appLayoutInverseHover `}
                >
            ...
            <div className="flex items-center justify-end gap-2 px-4 pb-2">
              <div className='h-full'>
                <Dialog.Close
                  className={`h-full flex items-center justify-center w-fit px-2 pt-px rounded-sm text-appLayoutHighlight text-optionsDropdownOptionFont hover:bg-appLayoutInverseHover `}
                >
                  Cancel
                </Dialog.Close>
              </div>
