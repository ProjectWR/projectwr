...
const DictionaryCreatePanel = ({}) => {
  ...
  const initialWordProperties = useRef({
    word: "",
    definition: "",
    synonyms: "",
  });
  ...
  const createWord = () => {
    dictionaryManager.addOrUpdateWord(
      wordProperties.word.toLowerCase(),
...
export default DictionaryCreatePanel;
