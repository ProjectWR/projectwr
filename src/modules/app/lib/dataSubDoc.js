...
class DataManagerSubdocs {
  ...
  createEmptyBook(ytree) {
    ...
    bookMap.set("item_properties", { "item_title": `Untitled Book #${ytree.getNodeChildrenFromKey("root")?.length}`, "item_description": "Book Description in Properties", "item_progress": 0 })
